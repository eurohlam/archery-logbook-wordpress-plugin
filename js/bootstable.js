...
Bootstable
 ...
 It has been customized by eurohlam with the purposes:
 - adapt it to bootstrap 5: glyphs have been replaced with bootstrap icons
 - project customization for better user experience
*/
"use strict";
//Global variables
...
$.fn.SetEditable = function (options) {
  ...
  $tabedi.find('thead tr').append('<th name="buttons"><span class="bi bi-hand-thumbs-up-fill"></span></th>');  //Add empty column
  if (!params.bootstrap) {
...
function butRowEdit(but) {
  ...
  IterarCamposEdit($cols, function($td) {  //itera por la columnas
      ...
      var input= '<input class="form-control input-sm" type="number" min="0" max="10" value="' + cont + '">';
